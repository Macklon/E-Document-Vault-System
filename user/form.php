  ...
  include ("mail.php");
   // include ("multishare.php");
    ...
    <tbody>
      ...
      <tr>
      	<form action="multishare.php" method="post">
        ...
        <td> 
            ...
            <input type="checkbox" name="check_list[]" value="<?php echo $row['file_name']; ?>"><img src=images/<?php echo $row['file_name']; ?> width=50 height=50> 
            <?php echo $row['file_name']; ?>
            </td>
        <?php } else { ?>
        <td>
         <input type="checkbox" name="check_list[]" value="<?php echo $row['file_name']; ?>"><img src=pic/pdf.svg  width=50 height=50>
         <?php echo $row['file_name']; ?>
</td>
        <?php } ?>
    ...
    <?php endwhile ?>
     <input type="submit" name="multi_share" value="Submit"/>
    </form>
