...
<body>
    ...
    <?php
            include ("connect.php");
            $disp="SELECT * FROM user_register ORDER by user_id DESC ";
            $result=mysqli_query($conn,$disp);
            
             if(isset($_GET["delete"])){
     mysqli_query($conn,"delete from user_register where user_id=".$_GET["delete"]."");

    $qry = mysqli_query($conn,"delete from files_upload where user_id=".$_GET["delete"]."");
    ...
    // }
            ...
            while ($row=mysqli_fetch_array($result)) :
                ...
                $disp1="SELECT files_id FROM files_upload where user_id=".$row['user_id']."";
            $result1=mysqli_query($conn,$disp1);
            $row_cnt = mysqli_num_rows($result1);
            
            $disp2="SELECT share_id FROM files_share where user_id=".$row['user_id']."";
    ...
    <tbody>
      <tr>  
        ...
        <td>
             <?php echo $row_cnt;?>     <a href=upload.php?view=<?php echo $row['user_id'];?>><i class="fa fa-eye" aria-hidden="true"> View</i></a>
        </td>

        <td>
             <?php echo $row_cnt2;?>     <a href=share.php?view=<?php echo $row['user_id'];?>><i class="fa fa-eye" aria-hidden="true"> View</i></a>
        </td>

        <td><a href=?delete=<?php echo $row['user_id']; ?> ><i class="fa fa-trash"></i></a></td>
