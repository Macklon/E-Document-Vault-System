    ...
    <div id="wrapper">
        ...
        <div class="ibox-content">
                ...
                <form method="post" enctype="multipart/form-data" action="" >
                    ...
                    <strong>Select Doc </strong><input type="file" name="uploadedimage" ><i class="fa fa-file"></i>
                    </label>
    ...
    <tbody>
      <tr>
        ...
        <td> 
            ...
            <img src=../user/images/<?php echo $row['file_name']; ?> width=50 height=50> 
            <?php echo $row['file_name']; ?>
            </td>
        <?php } else { ?>
        <td>
         <img src=../user/pic/pdf.svg  width=50 height=50>
         <?php echo $row['file_name']; ?>
</td>
        <?php } ?>
        <!-- <td><img src=../user/images/<?php echo $row['file_name'] ?> width=50 height=50>
               <?php echo $row['file_name']; ?>
        </td> -->
        <td>
<div class="dropdown">
    ...
    <ul class="dropdown-menu">
      <li>
        ...
        <form method="post" action="">
            ...
            <input  style="width:62%;" name="sent_email" placeholder="Enter email address" type="email">
  ...
  <?php
      ...
      <?php } ?>
        ...
        <td><?php echo $date; ?></td>
        <td><a href=../user/images/<?php echo $row['file_name'] ?> ><i class="fa fa-download"></i></a></td>
